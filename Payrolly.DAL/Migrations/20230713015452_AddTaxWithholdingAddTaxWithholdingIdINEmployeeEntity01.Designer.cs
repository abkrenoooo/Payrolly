...
namespace Payrolly.DAL.Migrations
{
    ...
    [Migration("20230713015452_AddTaxWithholdingAddTaxWithholdingIdINEmployeeEntity01")]
    partial class AddTaxWithholdingAddTaxWithholdingIdINEmployeeEntity01
    {
            ...
            modelBuilder.Entity("Payrolly.DAL.Entities.Employee", b =>
                {
                    ...
                    b.Property<string>("TaxWithholdingId")
                        .HasColumnType("nvarchar(450)");
            ...
            modelBuilder.Entity("Payrolly.DAL.Entities.Employee", b =>
                {
                    ...
                    b.HasOne("Payrolly.DAL.Entities.TaxWithholding", "TaxWithholding")
                        .WithMany()
                        .HasForeignKey("TaxWithholdingId");
