...
namespace Payrolly.DAL.Migrations
{
    ...
    [Migration("20230713013805_AddTaxWithholdingAddTaxWithholdingIdINEmployeeEntity")]
    partial class AddTaxWithholdingAddTaxWithholdingIdINEmployeeEntity
    {
            ...
            modelBuilder.Entity("Payrolly.DAL.Entities.Employee", b =>
                {
                    ...
                    b.Property<string>("TaxWithholdingd")
                        .HasColumnType("nvarchar(450)");
                    ...
                    b.HasIndex("TaxWithholdingd")
                        .IsUnique()
                        .HasFilter("[TaxWithholdingd] IS NOT NULL");
            ...
            modelBuilder.Entity("Payrolly.DAL.Entities.Employee", b =>
                {
                    ...
                    b.HasOne("Payrolly.DAL.Entities.TaxWithholding", "TaxWithholding")
                        .WithOne()
                        .HasForeignKey("Payrolly.DAL.Entities.Employee", "TaxWithholdingd");
